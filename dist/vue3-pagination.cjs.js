...
const _hoisted_2$2 = /*#__PURE__*/vue.createVNode("path", { d: "M18.41 16.59L13.82 12l4.59-4.59L17 6l-6 6 6 6 1.41-1.41M6 6h2v12H6V6z" }, null, -1 /* HOISTED */);
...
const _hoisted_2$3 = /*#__PURE__*/vue.createVNode("path", { d: "M5.59 7.41L10.18 12l-4.59 4.59L7 18l6-6-6-6-1.41 1.41M16 6h2v12h-2V6z" }, null, -1 /* HOISTED */);
...
const _hoisted_2$4 = /*#__PURE__*/vue.createVNode("path", { d: "M15.41 16.58L10.83 12l4.58-4.59L14 6l-6 6 6 6 1.41-1.42z" }, null, -1 /* HOISTED */);
...
const _hoisted_2$5 = /*#__PURE__*/vue.createVNode("path", { d: "M8.59 16.58L13.17 12 8.59 7.41 10 6l6 6-6 6-1.41-1.42z" }, null, -1 /* HOISTED */);
...
const render$6 = /*#__PURE__*/_withId$1((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return (vue.openBlock(), vue.createBlock("ul", _hoisted_1$6, [
    (!_ctx.hideFirstButton)
      ? (vue.openBlock(), vue.createBlock("li", _hoisted_2$6, [
          (_ctx.isPrevControlsActive)
            ? (vue.openBlock(), vue.createBlock("a", {
                key: 0,
                href: _ctx.removeURLParameter(_ctx.currentUrl, 'page'),
            ...
            : (vue.openBlock(), vue.createBlock(_component_icon_page_first, {
                key: 1,
                class: ["Control", { 'Control-active': _ctx.isPrevControlsActive }],
                onClick: _ctx.goToFirst
              }, null, 8 /* PROPS */, ["class", "onClick"]))
    ...
    vue.createVNode("li", _hoisted_3, [
      (_ctx.isPrevControlsActive)
        ? (vue.openBlock(), vue.createBlock("a", {
            key: _ctx.prevKey,
            href: _ctx.prevHref,
            onClick: _cache[2] || (_cache[2] = vue.withModifiers($event => (_ctx.prevKey++), ["prevent"]))
          }, [
        ...
        : (vue.openBlock(), vue.createBlock(_component_icon_chevron_left, {
            key: 1,
            class: ["Control", { 'Control-active': _ctx.isPrevControlsActive }],
            onClick: _ctx.goToPrev
          }, null, 8 /* PROPS */, ["class", "onClick"]))
    ...
    vue.createVNode("li", _hoisted_4, [
      (_ctx.isNextControlsActive)
        ? (vue.openBlock(), vue.createBlock("a", {
            key: _ctx.nextKey,
            href: _ctx.nextHref,
            onClick: _cache[3] || (_cache[3] = vue.withModifiers($event => (_ctx.nextKey++), ["prevent"]))
          }, [
        ...
        : (vue.openBlock(), vue.createBlock(_component_icon_chevron_right, {
            key: 1,
            class: ["Control", { 'Control-active': _ctx.isNextControlsActive }],
            onClick: _ctx.goToNext
          }, null, 8 /* PROPS */, ["class", "onClick"]))
    ...
    (!_ctx.hideLastButton)
      ? (vue.openBlock(), vue.createBlock("li", _hoisted_5, [
          (_ctx.isNextControlsActive)
            ? (vue.openBlock(), vue.createBlock("a", {
                key: 0,
                href: _ctx.currentUrl.replace(/(page=)[^\&]+/, '$1' + _ctx.pages),
                onClick: _cache[4] || (_cache[4] = vue.withModifiers(() => {}, ["prevent"]))
              }, [
            ...
            : (vue.openBlock(), vue.createBlock(_component_icon_page_last, {
                key: 1,
                class: ["Control", { 'Control-active': _ctx.isNextControlsActive }],
                onClick: _ctx.goToLast
              }, null, 8 /* PROPS */, ["class", "onClick"]))
