...
const _hoisted_2$2 = /*#__PURE__*/createVNode("path", { d: "M18.41 16.59L13.82 12l4.59-4.59L17 6l-6 6 6 6 1.41-1.41M6 6h2v12H6V6z" }, null, -1 /* HOISTED */);
...
const _hoisted_2$3 = /*#__PURE__*/createVNode("path", { d: "M5.59 7.41L10.18 12l-4.59 4.59L7 18l6-6-6-6-1.41 1.41M16 6h2v12h-2V6z" }, null, -1 /* HOISTED */);
...
const _hoisted_2$4 = /*#__PURE__*/createVNode("path", { d: "M15.41 16.58L10.83 12l4.58-4.59L14 6l-6 6 6 6 1.41-1.42z" }, null, -1 /* HOISTED */);
...
const _hoisted_2$5 = /*#__PURE__*/createVNode("path", { d: "M8.59 16.58L13.17 12 8.59 7.41 10 6l6 6-6 6-1.41-1.42z" }, null, -1 /* HOISTED */);
...
const render$6 = /*#__PURE__*/_withId$1((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return (openBlock(), createBlock("ul", _hoisted_1$6, [
    (!_ctx.hideFirstButton)
      ? (openBlock(), createBlock("li", _hoisted_2$6, [
          (_ctx.isPrevControlsActive)
            ...
            : (openBlock(), createBlock(_component_icon_page_first, {
                key: 1,
                class: ["Control", { 'Control-active': _ctx.isPrevControlsActive }],
                onClick: _ctx.goToFirst
              }, null, 8 /* PROPS */, ["class", "onClick"]))
    ...
    createVNode("li", _hoisted_3, [
      (_ctx.isPrevControlsActive)
        ? (openBlock(), createBlock("a", {
            key: _ctx.prevKey,
            href: _ctx.prevHref,
            onClick: _cache[2] || (_cache[2] = withModifiers($event => (_ctx.prevKey++), ["prevent"]))
          }, [
        ...
        : (openBlock(), createBlock(_component_icon_chevron_left, {
            key: 1,
            class: ["Control", { 'Control-active': _ctx.isPrevControlsActive }],
            onClick: _ctx.goToPrev
          }, null, 8 /* PROPS */, ["class", "onClick"]))
    ...
    createVNode("li", _hoisted_4, [
      (_ctx.isNextControlsActive)
        ? (openBlock(), createBlock("a", {
            key: _ctx.nextKey,
            href: _ctx.nextHref,
            onClick: _cache[3] || (_cache[3] = withModifiers($event => (_ctx.nextKey++), ["prevent"]))
          }, [
        ...
        : (openBlock(), createBlock(_component_icon_chevron_right, {
            key: 1,
            class: ["Control", { 'Control-active': _ctx.isNextControlsActive }],
            onClick: _ctx.goToNext
          }, null, 8 /* PROPS */, ["class", "onClick"]))
      ...
      ? (openBlock(), createBlock("li", _hoisted_5, [
          (_ctx.isNextControlsActive)
            ? (openBlock(), createBlock("a", {
                ...
                onClick: _cache[4] || (_cache[4] = withModifiers(() => {}, ["prevent"]))
              }, [
            ...
            : (openBlock(), createBlock(_component_icon_page_last, {
                key: 1,
                class: ["Control", { 'Control-active': _ctx.isNextControlsActive }],
                onClick: _ctx.goToLast
              }, null, 8 /* PROPS */, ["class", "onClick"]))
